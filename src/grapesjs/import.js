<body>
  ...
  <section class="bdg-sect" id="ipo08g">
    <div class="container-width" id="i4xku8">
      <h1 class="bdg-title">The team
      </h1>
      <div class="badges" id="ike41j">
        <div class="badge" id="iiofth">
          <div class="badge-header" id="i7keu4">
          </div>
        ...
        <div class="badge" id="i9nqw2">
          <div class="badge-header" id="iaifnm">
          </div>
